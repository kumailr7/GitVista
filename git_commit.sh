...
get_git_help() {
    ...
    # Display spinner while fetching help text
    local help_text
    help_text=$(gum spin -s pulse --title "AI is getting the response" -- \
...
commit_changes() {
    ...
    echo -e $(gum style --italic --bold --foreground 99 'Tailsman scans your files for git-leaks before commit')
